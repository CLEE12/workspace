...
<body bgcolor="<%=bodyback_c%>">
	<div align="center">
			...
			<table width="500" border="1" bgcolor="<%=bodyback_c%>">
				<tr>
					<td align="right" colspan="2" bgcolor="<%=value_c%>"><a
						href="../managerMain.jsp"> 관리자 메인으로</a> &nbsp; <a
						href="bookList.jsp?book_kind=<%=book_kind%>">목록으로</a></td>
				</tr>
				<tr>
					<td>분류 선택</td>
					<td><select name="book_kind">
				...
				<tr>
					...
					<td><input type="text" size="50" maxlength="50"
						name="book_title" value="<%=book.getBook_title()%>"> <input
						type="hidden" name="book_id" value="<%=book_id%>"></td>
				</tr>
				<tr>
					<td>가 격</td>
					<td><input type="text" size="10" maxlength="9"
						name="book_price" value="<%=book.getBook_price()%>">원</td>
				</tr>
				<tr>
					<td>수량</td>
					<td><input type="text" size="10" maxlength="5"
						name="book_count" value="<%=book.getBook_count()%>">권</td>
				</tr>
				<tr>
					<td>저자</td>
					<td><input type="text" size="10" maxlength="5" name="author"
						value="<%=book.getAuthor()%>"></td>
				</tr>
				<tr>
					<td>출판사</td>
					<td><input type="text" size="20" maxlength="30"
						name="publishing_com" value="<%=book.getPublishing_com()%>"></td>
				</tr>
				<tr>
					<td>출판일</td>
					<td><input type="date" name="publishing_date"
						value="<%=book.getPublishing_date()%>"> <%-- <select name="publishing_year">
        <%
        ...
        <%} %>
				...
				<tr>
					<td>이미지</td>
					<td><input type="file" name="book_image"
						value="<%=book.getBook_image()%>"><%=book.getBook_image()%></td>
				</tr>
				<tr>
					<td>내 용</td>
					<td><textarea name="book_content" rows="13" cols="40"><%=book.getBook_content()%></textarea>
					</td>
				</tr>
				<tr>
					<td>할인율</td>
					<td><input type="text" size="5" maxlength="2"
						name="discount_rate" value="<%=book.getDiscount_rate()%>">%</td>
				</tr>
				<tr>
					<td colspan=2 bgcolor="<%=value_c%>" align="center"><input
						type="button" value="책수정" onclick="updateCheckForm(this.form)">
