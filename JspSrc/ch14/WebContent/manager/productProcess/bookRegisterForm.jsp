...
<body bgcolor="<%=bodyback_c%>">
	<div align="center">
			...
			<table width="500" border="1">
				<tr>
					<td align="right" colspan="2" bgcolor="<%=value_c%>"><a
						href="../managerMain.jsp"> 관리자 메인으로</a></td>
				</tr>
				<tr>
					<td>분류 선택</td>
				...
				<tr>
					<td>저자</td>
					<td><input type="text" size="20" maxlength="30" name="author"></td>
				</tr>
				<tr>
					<td>출판사</td>
					<td><input type="text" size="20" maxlength="30"
						name="publishing_com"></td>
				</tr>
				<tr>
					<td>출판일</td>
					<td><input type="date" name="publishing_date"> <%-- <select name="publishing_year">
        <%
        ...
        <%} %>        
				...
				<tr>
					<td>내 용</td>
					<td><textarea name="book_content" rows="13" cols="40"></textarea>
					</td>
				</tr>
				<tr>
					<td>할인율</td>
				...
				<tr>
					<td colspan=2 bgcolor="<%=value_c%>" align="center"><input
						type="button" value="책등록" onclick="checkForm(this.form)">
