	...
	<table border="0" width="600" align="center">
		<tr height="30">
			<td rowspan="4" width="100" align="center" valign="middle"><a
				href="shopMain.jsp?pgm=bookContent.jsp?book_id=<%=bookLists[j].getBook_id()%>&book_kind=<%=bookLists[0].getBook_kind()%>">
 ...
 %> &nbsp;
		...
		<tr height="30">
			<td width="350">정가 : <s><%=NumberFormat.getInstance().format(bookLists[j].getBook_price())%></s>원<br>
				판매가 : <b><%=NumberFormat.getInstance().format((int) (bookLists[j].getBook_price()
							* ((double) (100 - bookLists[j].getDiscount_rate()) / 100)))%></b>원
			</td>
		</tr>
	</table>
	<%
