...
<body bgcolor="<%=bodyback_c%>">
	...
	<form name="inform" method="post" action="updateCart.jsp">
		<table border="1" width="750" align="center">
			...
			<tr>
				...
				<td width="300"><img
					src="../imageFile/<%=cartList.getBook_image()%>" border="0"
					width="30" height="50" align="middle"> <%=cartList.getBook_title()%>
				</td>
	...
	<form method="post" action="buyPro.jsp" name="buyinput">
		...
		<table width="600" border="1" cellspacing="0" cellpadding="3"
			...
			<tr>
				<td>전화번호</td>
				<td><input type="text" name="deliveryTel"
					value="<%=member.getTel()%>"></td>
			</tr>
			<tr>
				<td>주소</td>
				<td><input type="text" name="deliveryAddess"
