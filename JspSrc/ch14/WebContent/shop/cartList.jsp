...
<body bgcolor="<%=bodyback_c%>">
	<div align="center">
		...
		<table border="1" width="650" cellpadding="3" cellspacing="3"
			align="center">
			<tr>
				<td align="center">장바구니에 담긴 물품이 없습니다.</td>
			</tr>
		</table>
		...
		<table border="1" width="750" align="center">
			...
			<tr>
				...
				<td width="300"><img
					src="../imageFile/<%=cart.getBook_image()%>" border="0" width="30"
					height="50" align="middle"> <%=cart.getBook_title()%></td>
				...
				<td width="150" align="center">
					<form name="inform" method="post" action="updateCart.jsp">
						<input type="text" name="buy_count" size="5"
							value="<%=cart.getBuy_count()%>"> <input type="hidden"
							name="cart_id" value="<%=cart.getCart_id()%>"> <input
				...
				<td align="center" width="150" align="center">
					...
					onclick="location.href='cartListDel.jsp?list=<%=cart.getCart_id()%>&book_kind=<%=book_kind%>'">
				</td>
			</tr>
			<%
				}
				...
				<td colspan="5" align="center">
					<form>
						...
						<input type="button" value="장바구니비우기"
							onclick="location.href='cartListDel.jsp?list=all&book_kind=<%=book_kind%>'">
					</form>
				</td>
			</tr>
		</table>
