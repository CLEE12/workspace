	...
	<table width="850">
		...
		<tr>
			...
			<td width="700" valign="top">
				...
				<h3><%=book_kindName%>
					분류의 목록
				</h3> <a href="<%=path%>/shop/shopMain.jsp">메인으로</a> <%
				...
				<table width="600" align="center">
					<tr height="30" bgcolor="<%=value_c%>">
						<td rowspan="4" width="100" align="center" valign="middle"><a
							href="shopMain.jsp?pgm=bookContent.jsp?book_id=<%=bookList.getBook_id()%>&book_kind=<%=book_kind%>">
								<img src="<%=path%>/imageFile/<%=bookList.getBook_image()%>"
 ...
 %> &nbsp;
					...
					<tr height="30" bgcolor="<%=value_c%>">
						<td width="350">정가 : <s><%=NumberFormat.getInstance().format(bookList.getBook_price())%></s><br>
							판매가 : <b><%=NumberFormat.getInstance().format(
						(int) (bookList.getBook_price() * ((double) (100 - bookList.getDiscount_rate()) / 100)))%></b></td>
					</tr>
				</table> <br> <%
 	}
 %>
