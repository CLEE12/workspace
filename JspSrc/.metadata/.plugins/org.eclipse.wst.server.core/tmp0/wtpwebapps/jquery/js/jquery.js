				...
				function(window, noGlobal) {
					...
					init = jQuery.fn.init = function(selector, context, root) {
						...
						if (typeof selector === "string") {
							...
							return root.ready !== undefined ? root
									.ready(selector) :
					...
					Data.prototype = {
						...
						register : function(owner, initial) {
							...
							// If it is a node unlikely to be stringify-ed or
							// looped over
							...
							if (owner.nodeType) {
								...
								// configurability must be true to allow the
								// property to be
						...
						cache : function(owner) {
							...
							if (!value) {
								...
								if (acceptData(owner)) {
									...
									// If it is a node unlikely to be
									// stringify-ed or looped over
									// use plain assignment
									if (owner.nodeType) {
										owner[this.expando] = value;

										// Otherwise secure it in a
										// non-enumerable property
										// configurable must be true to allow
										// the property to be
						...
						set : function(owner, data, value) {
							...
							if (typeof data === "string") {
								...
								// Copy the properties one-by-one to the cache
								// object
								for (prop in data) {
						...
						access : function(owner, key, value) {
							...
							// When the key is not a string, or both a key and
							// value
						...
						remove : function(owner, key) {
							...
							if (key === undefined
								...
								// Webkit & Blink performance suffers when
								// deleting properties
					...
					jQuery.extend({
						...
						// have been replaced
						// with direct calls to dataPriv methods, these can be
						// deprecated.
					...
					jQuery.fn
							.extend({
								...
								promise : function(type, obj) {
									...
									while (i--) {
										tmp = dataPriv.get(elements[i], type
												+ "queueHooks");
										if (tmp && tmp.empty) {
											count++;
					...
					var wrapMap = {
						...
						// same way that tag soup parsers do. So we cannot
						// shorten
					...
					function getAll(context, tag) {
						...
						// Support: IE9-11+
						// Use typeof to avoid zero-argument method invocation
						// on host objects (#15151)
						var ret = typeof context.getElementsByTagName !== "undefined" ? context
								.getElementsByTagName(tag || "*")
					...
					jQuery.event = {
						...
						add : function(elem, types, handler, data, selector) {
							...
							var handleObjIn, eventHandle, tmp, events, t, handleObj, special, handlers, type, namespaces, origType, elemData = dataPriv
									.get(elem);
						...
						remove : function(elem, types, handler, selector,
							...
							var j, origCount, tmp, events, t, handleObj, special, handlers, type, namespaces, origType, elemData = dataPriv
									.hasData(elem)
									&& dataPriv.get(elem);
						...
						dispatch : function(event) {
							...
							var i, j, ret, matched, handleObj, handlerQueue = [], args = slice
									.call(arguments), handlers = (dataPriv.get(
					...
					function domManip(collection, args, callback, ignored) {
						...
						var fragment, first, scripts, hasScripts, node, doc, i = 0, l = collection.length, iNoClone = l - 1, value = args[0], isFunction = jQuery
								.isFunction(value);
					...
					function remove(elem, selector, keepData) {
						var node, nodes = selector ? jQuery.filter(selector,
								elem) : elem, i = 0;
									...
									for (; (elem = elems[i]) !== undefined; i++) {
										if (acceptData(elem)) {
											if ((data = elem[dataPriv.expando])) {
												...
												// Support: Chrome <= 35-45+
												// Assign undefined instead of
												// using delete, see Data#remove
					...
					(function() {
						var pixelPositionVal, boxSizingReliableVal, pixelMarginRightVal, reliableMarginLeftVal, container = document
								...
								.extend(
										support,
										{
											pixelPosition : function() {
												...
												// This test is executed only
												// once but we still do
												// memoizing
												// since we can use the
												// boxSizingReliable
												// pre-computing.
												// No need to check if the test
											...
											pixelMarginRight : function() {
												...
												// We're checking for
												// boxSizingReliableVal here
												// instead of
												// pixelMarginRightVal
												// since that compresses better
												// and they're computed together
												// anyway.
												if (boxSizingReliableVal == null) {
													computeStyleTests();
												}
											...
											reliableMarginLeft : function() {
												...
												// Support: IE <=8 only, Android
												// 4.0 - 4.3 only, Firefox <=3 -
												// 37
												if (boxSizingReliableVal == null) {
													computeStyleTests();
												}
											...
											reliableMarginRight : function() {
												...
												// Support: Android 2.3
												// Check if div with explicit
												// width and no margin-right
												// incorrectly
												// gets computed margin-right
												// based on width of container.
												// (#3333)
												// WebKit Bug 13343 -
												// getComputedStyle returns
												// wrong value for margin-right
												// This support function is only
												// executed once so no memoizing
												// is needed.
												...
												ret = !parseFloat(window
														.getComputedStyle(marginDiv).marginRight);
					...
					function curCSS(elem, name, computed) {
						...
						if (computed) {
							...
							// Android Browser returns percentage for some
							// values,
						...
						for (; index < length; index++) {
							...
							if (show) {
								...
								if (elem.style.display === "" && isHidden(elem)) {
									values[index] = dataPriv.access(elem,
											"olddisplay",
									...
									function(i, name) {
										jQuery.cssHooks[name] = {
											...
											set : function(elem, value, extra) {
												var matches, styles = extra
														&& getStyles(elem), subtract = extra
					...
					function defaultPrefilter(elem, props, opts) {
						...
						var prop, value, toggle, tween, hooks, oldfire, display, checkDisplay, anim = this, orig = {}, style = elem.style, hidden = elem.nodeType
								&& isHidden(elem), dataShow = dataPriv.get(
								elem, "fxshow");
						...
						if (elem.nodeType === 1
							...
							// "none"
							checkDisplay = display === "none" ? dataPriv.get(
									elem, "olddisplay")
									...
									return this
											.each(function() {
												var dequeue = true, index = type != null
														&& type + "queueHooks", timers = jQuery.timers, data = dataPriv
														.get(this);
									...
									jQuery.event,
									{
										...
										trigger : function(event, data, elem,
											...
											var i, cur, tmp, bubbleType, ontype, handle, special, eventPath = [ elem
													|| document ], type = hasOwn
													.call(event, "type") ? event.type
													: event, namespaces = hasOwn
											...
											// focus/blur morphs to focusin/out;
											// ensure we're not firing them
											// right now
											...
											if (type.indexOf(".") > -1) {
												...
												// regexp to match event type in
												// handle()
												namespaces = type.split(".");
												type = namespaces.shift();
												namespaces.sort();
											}
											ontype = type.indexOf(":") < 0
													&& "on" + type;

											// Caller can pass in a jQuery.Event
											// object, Object, or just an event
											// type string
											...
											// Trigger bitmask: & 1 for native
											// handlers; & 2 for jQuery (always
											// true)
											...
											// Clean up the event in case it is
											// being reused
											...
											// Clone any incoming data and
											// prepend the event, creating the
											// handler arg list
											data = data == null ? [ event ]
													: jQuery.makeArray(data,
															[ event ]);

											// Allow special events to draw
											// outside the lines
											special = jQuery.event.special[type]
													|| {};
											if (!onlyHandlers
											...
											// in advance, per W3C events spec
											// (#9951)
											// Bubble up to document, then to
											// window; watch for a global
											...
											if (!onlyHandlers
												...
												// Only add window if we got to
												// document (e.g., not plain obj
												// or detached DOM)
												if (tmp === (elem.ownerDocument || document)) {
													eventPath
															.push(tmp.defaultView
																	|| tmp.parentWindow
																	|| window);
												}
											}
											...
											// If nobody prevented the default
											// action, do it now
											if (!onlyHandlers
													&& !event
															.isDefaultPrevented()) {
												...
												if ((!special._default || special._default
													...
													// Call a native DOM method
													// on the target with the
													// same name name as the
													// event.
													// Don't do default actions
													// on window, that's where
													// global variables be
													// (#6170)
													if (ontype
															&& jQuery
										...
										simulate : function(type, elem, event) {
											var e = jQuery.extend(
													...
													// would not be triggered on
													// donor event, since in our
													// own
													// jQuery.event.stopPropagation
													// function we had a check
													// for existence of
													// originalEvent.stopPropagation
													// method, so, consequently
													// it would be a noop.
													//
													// But now, this "simulate"
													// function is used only for
													// events
													// for which
													// stopPropagation() is
													// noop, so there is no need
													// for that anymore.
													//
													// For the 1.x branch
													// though, guard for "click"
													// and "submit"
													// events is still used, but
													// was moved to
													// jQuery.event.stopPropagation
													// function
													// because `originalEvent`
													// should point to the
													// original event for the
													// constancy
													// with other events and for
													// more focused logic
													});
					...
					jQuery
							.extend({
								...
								ajax : function(url, options) {
									...
									// the origin doesn't match the current
									// origin.
									if (s.crossDomain == null) {
										urlAnchor = document.createElement("a");

										// Support: IE8-11+
										// IE throws exception if url is
										// malformed, e.g.
										...
										try {
											...
											// Support: IE8-11+
											// Anchor's host property isn't
											// correctly set when s.url is
											// relative
											urlAnchor.href = urlAnchor.href;
											s.crossDomain = originAnchor.protocol
													+ "//" + originAnchor.host !== urlAnchor.protocol
													+ "//" + urlAnchor.host;
										} catch (e) {

											// If there is an error parsing the
											// URL, assume it is crossDomain,
											// it can be rejected by the
											// transport if it is invalid
											s.crossDomain = true;
										}
									}
					...
					jQuery.expr.filters.visible = function(elem) {
						...
						// Use OR instead of AND as the element is not visible
						// if either is true
								...
								if (support.cors || xhrSupported
									...
									return {
										send : function(headers, complete) {
											...
											// Support: IE9
											// Use onreadystatechange to replace
											// onabort
					...
					jQuery.fn
							.extend({
								...
								// This method will return documentElement in
								// the following cases:
								// 1) For the element inside the iframe without
								// offsetParent, this method will return
								// documentElement of the parent window
								// 2) For the hidden or detached element
								// 3) For body or html element, i.e. in case of
								// the html node - it will return itself
								//
								// but those exceptions were never presented as
								// a real life use-cases
								// and might be considered as more preferable
								// results.
								//
								// This logic, however, is not guaranteed and
								// can change at any point in the future
