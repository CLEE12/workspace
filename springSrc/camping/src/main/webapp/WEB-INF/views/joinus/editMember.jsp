	...
	<form action="editMember.html" name="form" method="post" >		
		...
		<thead>		
			...
			<tr><th scope="row">이름</th>
				<td><input type="text" name="mName" value="${member.mName }" class="txt t02"></td>
			</tr>
			<tr>
				<th scope="row">우편번호</th>
				<td><input type="text" name="postcode" value="${member.postcode }" class="txt t02"></td>
			</tr>
			<tr><th scope="row">주소</th>
				<td><input type="text" name="address" value="${member.address }" class="txt t01"></td>
			</tr>
